<div class="container">
<h5><a href="<?php echo base_url("index.php/NewArrivals") ?>">New Arrivals</a></h5>
    <div id="itemgrid" style="margin-top: 20px;" class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-sm-2 row-cols-2">
        <?php
